<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BorrarP.aspx.cs" Inherits="BorrarP" %>
...
<head>
  ...
  <title>Borrar Preguntas En Js!</title>
    ...
    <div class="container  ">
      <div class="row">
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2" colspan="2">Borrar PreguntaS</td>
            </tr>
            <tr>
                <td class="auto-style13">Pregunta A Borrar</td>
            ...
            <tr>
                <td class="auto-style7">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EmpresaReparaciónPCConnectionString %>" DeleteCommand="DELETE FROM TB_Preguntas where ID_Servicio = @ID_Servicio" ProviderName="<%$ ConnectionStrings:EmpresaReparaciónPCConnectionString.ProviderName %>">
                        <DeleteParameters>
                            <asp:Parameter Name="ID_Servicio" />
                        </DeleteParameters>
                    </asp:SqlDataSource>
                </td>
            ...
            <tr>
                <td class="auto-style9">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Delete" BackColor="White" BorderColor="Black" BorderStyle="Solid" CssClass="auto-style17" />
                </td>
                <td class="auto-style10">
                    <asp:Label ID="Label1" runat="server" Text="   " CssClass="auto-style11"></asp:Label>
                </td>
            </tr>
            <tr>
        ...
        <div class="col-md-6 ">
          <div class="img-box">
              <h2 class="auto-style15"><strong>Formulario Sobre Borrado De Preguntas</strong></h2>
            <img src="images/Gifoo.gif" alt="">
          </div>
        </div>
