<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporVieGf.aspx.cs" Inherits="ReporVieGf" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <title>Reporte Gráfico Js!</title>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td colspan="2">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" SizeToReportContent="True" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="498px" Width="858px">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="EmpresaReparaciónPCDataSetTableAdapters.articulosTableAdapter"></asp:ObjectDataSource>
                </td>
            </tr>
        </table>
    <div>
